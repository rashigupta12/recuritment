...
import { Award, Search, User, X, Mail, Phone, MapPin, FileText, Briefcase, Calendar } from 'lucide-react';
...
export default function ViewApplicantPage() {
  ...
  // Add state for selected applicant in details modal
  ...
  // Add function to close details modal
      ...
      <div className="w-full mx-auto">
        ...
        {filteredApplicants.length === 0 ? (
          ...
          <ApplicantsTable
            ...
            showCheckboxes={true}
            showStatus={true}
            onRowClick={handleOpenDetailsModal} // Pass the handler to open details modal
          />
        )}
      </div>
            ...
            <div className="mb-4">
              ...
              {selectedApplicant.custom_experience && selectedApplicant.custom_experience.length > 0 ? (
                <div className="space-y-2">
                  {selectedApplicant.custom_experience.slice(0, 1).map((exp, index) => (
