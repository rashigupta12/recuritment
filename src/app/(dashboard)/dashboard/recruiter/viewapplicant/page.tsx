...
import { Search, X, User, Mail, Phone, MapPin, FileText, Briefcase, Calendar } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" role="dialog" aria-modal="true" aria-labelledby="status-modal-title">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md">
            <div className="flex items-center justify-between mb-4">
              <h2 id="status-modal-title" className="text-xl font-bold text-gray-900">
            ...
            <div className="mb-4">
              <label className="block text-gray-700 mb-2 font-medium">Select New Status</label>
              <select
            ...
            <p className="text-gray-600 mb-4">
              Changing status for {selectedApplicants.length} applicant(s) to <strong>{selectedStatus}</strong>
            </p>
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 mb-6 border border-blue-100">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <span className={`px-3 py-1 rounded-full text-sm font-semibold border ${getStatusColor(selectedApplicant.status)}`}>
                    ...
                    <div key={index} className="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2 gap-2">
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                          exp.current_company ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-gray-100 text-gray-600 border border-gray-200'
                        }`}>
