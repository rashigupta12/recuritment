...
interface AssessmentStagedApplicantsTableRowProps {
  applicant: JobApplicant;
}

export const AssessmentStagedApplicantsTableRow = ({
  applicant,
}: AssessmentStagedApplicantsTableRowProps) => {
  return (
    <tr
      className="md:table-row flex flex-col gap-2 p-3 border-b md:border-b-0 bg-white md:bg-transparent hover:bg-gray-50"
    >
      <td className="md:table-cell px-3 py-2">
        {/* Empty cell for alignment with checkbox column */}
      ...
      <td className="md:table-cell px-3 py-2 flex flex-col gap-0.5">
        ...
        <div className="text-xs text-gray-500 truncate max-w-[120px]" title={applicant.email_id}>
          {applicant.email_id || '-'}
        </div>
