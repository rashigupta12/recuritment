    ...
    if (!applicants.length) {
        return (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center shadow-sm">
                <p className="text-yellow-800 font-semibold text-lg">No tagged applicants found</p>
        ...
        <div className="flex justify-between gap-3 items-center flex-nowrap">
            ...
            {assessmentError && (
                <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg shadow-sm flex items-center gap-2">
                    <AlertCircle className="h-5 w-5 text-red-600" />
                    <div>
                        <p className="text-red-800 font-semibold text-sm">Assessment Error</p>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-3 max-h-64 overflow-y-auto">
                                {selectedApplicants.map((applicant) => (
                                    <div key={applicant.name} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center">
                                                <User className="h-4 w-4 text-blue-600" />
                                            </div>
                                            <div>
                                                <p className="font-semibold text-gray-900 text-sm">{applicant.applicant_name || applicant.name}</p>
            ...
            {isAssessmentModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" role="dialog" aria-modal="true" aria-labelledby="assessment-modal-title">
                    <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl transform transition-all duration-300 ease-in-out">
                        <div className="flex items-center justify-between mb-4 border-b border-gray-100 pb-3">
                            <h2 id="assessment-modal-title" className="text-xl font-bold text-gray-900 flex items-center gap-2">
                                Create Assessment
                            </h2>
                            <button
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div>
                                <label className="block text-gray-700 font-semibold mb-2 text-sm">Date of Assessment</label>
                                <input
                                    type="date"
                                    value={scheduledOn}
                            ...
                            <div>
                                <label className="block text-gray-700 font-semibold mb-2 text-sm">Start Time</label>
                                <input
                                    type="time"
                                    value={fromTime}
                            ...
                            <div>
                                <label className="block text-gray-700 font-semibold mb-2 text-sm">End Time</label>
                                <input
                                    type="time"
                                    value={toTime}
